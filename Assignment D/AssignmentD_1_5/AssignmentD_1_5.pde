...
void draw() {
  ...
  if (state==1) {
    ...
    camera();
    camera(900, 280, -800, 800.0, height/2, 0.0, 
       0.0, 1.0, 0.0);
    ...
    for (int i = 0; i < in.bufferSize() - 1; i++)
    {
     ...
     line(width * noise(x / 1000, time), height/2 + in.left.get(i)*150, i, width/2 * noise(x / 100, time));
    ...
    for (int i = 0; i < in.bufferSize() - 1; i++)
    {
      ...
      translate(width/2, (in.left.get(i)*0.5));
